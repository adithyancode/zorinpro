...
echo "https://github.com/adithyancode/zorinpro IS THE OFFICIAL SOURCE FOR THIS TOOL."
...
function fail() {
	echo ""
	echo "You are not running this script correctly, read the GitHub https://github.com/adithyancode/zorinpro/ for more info"
	echo ""
	exit 1
}
...
if ! curl -L -H 'DNT: 1' -H 'Sec-GPC: 1' https://github.com/adithyancode/zorinpro/raw/refs/heads/main/raw/zorin-os.gpg --output "$TEMPD/zorin-os.gpg"; then
...
if [ "$version" = "18" ]; then
	if ! curl -L -H 'DNT: 1' -H 'Sec-GPC: 1' https://github.com/adithyancode/zorinpro/raw/refs/heads/main/raw/zorin-os-premium-18.gpg --output "$TEMPD/zorin-os-premium-18.gpg"; then
	...
	if ! curl -L -H 'DNT: 1' -H 'Sec-GPC: 1' https://github.com/adithyancode/zorinpro/raw/refs/heads/main/raw/zorin-os-premium.gpg --output "$TEMPD/zorin-os-premium.gpg"; then
		echo "Error: Failed to download premium public gpg key."
		exit 1
	fi
...
if dpkg -s "zorin-os-premium-keyring" >/dev/null 2>&1; then
	...
	if [ "$version" = "18" ]; then
		if ! bash <(curl -H 'DNT: 1' -H 'Sec-GPC: 1' -fsSL https://github.com/adithyancode/zorinpro/raw/refs/heads/main/make_dummy_deb.sh) -w "$TEMPD/Dummy/" -n zorin-os-premium-keyring -v 1.1 -o "$TEMPD/zorin-os-premium-keyring.deb"; then
			echo "Warning: Failed to create dummy deb for zorin-os-premium-keyring (1.1). Continuing anyway..."
		fi
	else
		if ! bash <(curl -H 'DNT: 1' -H 'Sec-GPC: 1' -fsSL https://github.com/adithyancode/zorinpro/raw/refs/heads/main/make_dummy_deb.sh) -w "$TEMPD/Dummy/" -n zorin-os-premium-keyring -v 1.0 -o "$TEMPD/zorin-os-premium-keyring.deb"; then
...
if dpkg -s "zorin-os-keyring" >/dev/null 2>&1; then
	...
	if ! bash <(curl -H 'DNT: 1' -H 'Sec-GPC: 1' -fsSL https://github.com/adithyancode/zorinpro/raw/refs/heads/main/make_dummy_deb.sh) -w "$TEMPD/Dummy/" -n zorin-os-keyring -v 1.1 -o "$TEMPD/zorin-os-keyring.deb"; then
...
echo ""
echo "All done!"
echo "If you have any questions or comments please see https://github.com/adithyancode/zorinpro/discussions/29 for more information on how to deal with them."
echo ""
echo "If you are using this tool and have issues please file a bug report about said issues on GitHub https://github.com/adithyancode/zorinpro/issues/new?template=bug_report.yml"
echo ""
